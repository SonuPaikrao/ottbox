        ...
        const fetchNotifications = async () => {
            try {
                ...
                if (res.ok) {
                    ...
                    // Auto-clean dismissed list — remove IDs that are no longer active
                    // so if same notification is re-activated it can show again
                    setDismissed(prev => prev.filter(id => fresh.some(n => n.id === id)));
                }
            } catch (error) {
